        ...
        <div className='relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200'>
            <div className='flex items-center justify-between px-4 py-2 bg-gray-100 border-b border-gray-200'>
                <div className='flex items-center space-x-2'>
                    ...
                    <span className='text-xs font-semibold text-gray-600 uppercase tacking-wide'>
                        {language || "Code"}
                    </span>
                </div>
                <button
                    onClick={copyCode}
                    className='text-gray-500 hover:text-gray-700 focus:outline-nonr relative group'
